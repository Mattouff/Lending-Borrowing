...
contract InterestRateStrategyTest is Test {
    ...
    function setUp() public {
        ...
        vm.startPrank(admin);
        strategy =
            new InterestRateStrategy(BASE_BORROW_RATE, SLOPE1, SLOPE2, OPTIMAL_UTILIZATION_RATE, ELASTICITY_FACTOR);
        vm.stopPrank();
    }
    ...
    function testZeroUtilization() public view {
        ...
        (uint256 liquidityRate, uint256 stableBorrowRate, uint256 variableBorrowRate) =
    ...
    function testOptimalUtilization() public view {
        ...
        assertApproxEqRel(
            ...
            expectedBorrowRate,
            0.0001e18,
            "Variable borrow rate should be base + slope1 at optimal utilization"
        );
        ...
        assertApproxEqRel(
            liquidityRate, expectedLiquidityRate, 0.0001e18, "Liquidity rate should be calculated correctly"
        );
    }
    ...
    function testHighUtilization() public view {
        ...
        assertTrue(
            variableBorrowRate > optimalBorrowRate, "Variable borrow rate should be higher than at optimal utilization"
        );
    ...
    function testInterestRateResponseToUtilization() public view {
        ...
        assertTrue(
            ratePerPercentAfterOptimal1 > ratePerPercentBeforeOptimal,
            "Rate increase should accelerate after optimal utilization"
        );
        assertTrue(
            ratePerPercentAfterOptimal2 > ratePerPercentAfterOptimal1,
